...
export const categories = ['Lifestyle', 'Jordan', 'Running', 'Baloncesto', 'Fútbol', 'Gym', 'Skateboard', 'Golf', 'Tenis']
...
export const optionsFilter = [
  { id: 1, name:'category', options: categories },
  { id: 2, name:'stars', options: rangeStars },
  { id: 3, name:'gender', options: gender },
]
